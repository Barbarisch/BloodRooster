...
from dbmodel import get_session
from dbmodel.spnservice import SPNService
from dbmodel.adsd import JackDawSD
from dbmodel.adgroup import Group
from dbmodel.adinfo import ADInfo
from dbmodel.aduser import ADUser
from dbmodel.admachine import Machine
from dbmodel.adou import ADOU
from dbmodel.adinfo import ADInfo
from dbmodel.adtrust import ADTrust
from dbmodel.adgpo import GPO
from dbmodel.constrained import MachineConstrainedDelegation
from dbmodel.adgplink import Gplink
from dbmodel.adspn import JackDawSPN
from dbmodel.netsession import NetSession
from dbmodel.localgroup import LocalGroup
from dbmodel.credential import Credential
# from jackdaw.wintypes.well_known_sids import get_name_or_sid, get_sid_for_name
# from jackdaw.wintypes.lookup_tables import *
from graph.graphdata import *
# from jackdaw import logger
# from jackdaw.utils.encoder import UniversalEncoder
from dbmodel import windowed_query
from graph.construct import GraphConstruct
...
class DomainGraph:
	...
	def all_shortest_paths(self, src_sid=None, dst_sid=None):
		...
		if not src_sid and not dst_sid:
			...
			try:
				# for each node we calculate the shortest path to the destination node,
				# silently skip the ones who do not have path to dst
				inqueue = mp.Queue()
				outqueue = mp.Queue()
				procno = mp.cpu_count()
